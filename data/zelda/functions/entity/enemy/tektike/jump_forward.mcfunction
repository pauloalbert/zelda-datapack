...
execute store result entity @s Motion[2] double 0.0005 run scoreboard players get out math
function math:trig/sin
execute store result entity @s Motion[0] double -0.0005 run scoreboard players get out math
