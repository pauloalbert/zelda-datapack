...
execute if score @s State matches 0 on passengers if entity @s[tag=display,score={State=!-1}] run data merge entity @s {block_state:{Name:"sculk_catalyst"},interpolation_duration:30, transformation:{scale:[1f, 1f, 1f]},interpolation_start:-1}
