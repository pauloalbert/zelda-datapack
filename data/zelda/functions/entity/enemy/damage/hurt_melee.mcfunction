...
execute unless score @s HurtTimer matches ..-1 as @s at @a[limit=1,tag=player_hitting_filter] unless score @s Health matches ..0 if score GAME Freeze matches 0 run function zelda:entity/enemy/damage/knockback
