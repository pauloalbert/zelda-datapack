...
summon item_display ~ ~ ~ {Tags:[hurts_enemy,controller,sword,TEMP_SPAWN,projectile,"ANIMATED"],item:{id:"netherite_sword",Count:1b},"transformation":{"translation":[0f,0.49f,0f],scale:[1f,1f,1f],left_rotation:[0f,1f,0f,0f],right_rotation:[0f,0f,0f,1f]}}
