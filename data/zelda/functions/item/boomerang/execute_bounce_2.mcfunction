...
execute unless block ~ ~ ~ passable_blocks run tellraw @a[tag=debugger] {"text": "IN A BLOCK"}
execute unless block ~ ~ ~ passable_blocks run scoreboard players set @s State 1
...
execute unless block ~-0.01 ~ ~ passable_blocks run scoreboard players operation @s behavior2 *= #-1 constant
execute unless block ~0.01 ~ ~ passable_blocks run scoreboard players operation @s behavior2 *= #-1 constant

execute unless block ~ ~0.01 ~ passable_blocks run scoreboard players operation @s behavior3 *= #-1 constant
execute unless block ~ ~-0.01 ~ passable_blocks run scoreboard players operation @s behavior3 *= #-1 constant

execute unless block ~ ~ ~-0.01 passable_blocks run scoreboard players operation @s behavior2 *= #-1 constant
execute unless block ~ ~ ~0.01 passable_blocks run scoreboard players operation @s behavior2 *= #-1 constant
execute unless block ~ ~ ~-0.01 passable_blocks run scoreboard players operation @s behavior2 += #18000 constant
