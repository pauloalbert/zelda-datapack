...
execute anchored eyes run summon item_display ^ ^ ^0.2 {Tags:["boomerang","red","SPAWN_TEMP"],item:{id:"oak_trapdoor",Count:1b,tag:{CustomModelData:2}},transformation:{scale:[1f, 1f, 1f],translation:[0f,0.2f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
