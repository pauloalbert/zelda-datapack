...
execute facing entity @a[tag=boomerang_player_filter,limit=1,sort=nearest] eyes run tp @s ^ ^ ^0.7
execute unless entity @a[tag=boomerang_player_filter] run kill @s